...
# ==============================================================================
"""Base classes for Tron A1 solefoot."""
...
class TronA1SoloFootEnv(mjx_env.MjxEnv):
  """Base class for Tron A1 Solo Foot environments."""
  ...
  def get_left_feet_zaxis(self, data: mjx.Data) -> jax.Array:
    """Return the upvector of the left foot in the world frame."""
    return mjx_env.get_sensor_data(
        self.mj_model, data, consts.LEFT_FOOT_UPVECTOR_SENSOR
    )
  
  def get_right_feet_zaxis(self, data: mjx.Data) -> jax.Array:
    """Return the upvector of the right foot in the world frame."""
    return mjx_env.get_sensor_data(
        self.mj_model, data, consts.RIGHT_FOOT_UPVECTOR_SENSOR
    )
