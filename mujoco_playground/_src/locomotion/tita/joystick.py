...
class Joystick(tita_base.TitaEnv):
  ...
  def _post_init(self) -> None:
    ...
    self._weights = jp.array([
        1.0, 0.05, 0.05, 0.0,  # left leg.
        1.0, 0.05, 0.05, 0.0,  # right leg.
    ])
    # fmt: on
    ...
    qpos_noise_scale = self._config.noise_config.scales.joint_pos * np.ones(8)
  ...
  def _cost_feet_clearance(
    ...
    foot_z = foot_pos[..., -1] - self._WHEEL_RADIUS
